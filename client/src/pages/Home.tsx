...
export default function Home() {
  ...
  const handleDiscordCopy = () => {
    navigator.clipboard.writeText('riftnow');
    showToast('copied riftnow to clipboard');
  };

  const handleGithubTermed = () => {
    showToast('sorry pal but my github got termed 💔');
  };
      ...
      <div ref={containerRef} className="text-center max-w-2xl px-4 z-10 relative">
        <div className="mb-8 flex justify-center" style={{ animation: 'wobble 4s infinite ease-in-out' }}>
          <svg viewBox="0 0 100 100" className="w-24 h-24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M50,20 C65,18 82,30 80,50 C78,70 60,85 45,80 C30,75 15,60 20,40 C25,20 35,22 50,20"
              fill="none"
              stroke="white"
              strokeWidth="3"
            />
            <line x1="50" y1="5" x2="50" y2="15" stroke="white" strokeWidth="3" strokeLinecap="round" />
            <line x1="85" y1="15" x2="75" y2="25" stroke="white" strokeWidth="3" strokeLinecap="round" />
            <line x1="95" y1="50" x2="85" y2="50" stroke="white" strokeWidth="3" strokeLinecap="round" />
            <line x1="15" y1="15" x2="25" y2="25" stroke="white" strokeWidth="3" strokeLinecap="round" />
            <line x1="5" y1="50" x2="15" y2="55" stroke="white" strokeWidth="3" strokeLinecap="round" />
            <line x1="30" y1="85" x2="40" y2="75" stroke="white" strokeWidth="3" strokeLinecap="round" />
          </svg>
        </div>

        <h1 className="text-6xl font-bold text-white mb-2">rift</h1>
        
        <div className="flex items-center justify-center gap-3 mb-8">
          <span className="text-2xl text-white opacity-80">cool developer</span>
          <svg viewBox="0 0 100 100" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
            <path d="M50,90 Q18,68 15,45 Q12,28 28,15 Q42,5 50,18 Q58,5 72,15 Q88,28 85,45 Q82,68 50,90" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M40,45 L50,58 L60,45" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <circle cx="32" cy="32" r="2.5" fill="white" />
            <circle cx="68" cy="34" r="2.5" fill="white" />
            <path d="M42,68 Q50,73 58,68" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </div>

        <div className="relative h-32 mb-12 flex items-end">
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          ...
          <button
            className="wobbly-button"
            style={{ '--rotation': '1.5' } as React.CSSProperties}
            onClick={handleGithubTermed}
          >
            github
          </button>
          <button
            className="wobbly-button"
            style={{ '--rotation': '-1' } as React.CSSProperties}
            onClick={() => window.open('https://v3rm.net/members/rift.103078/', '_blank')}
          >
            stuff
          </button>
        </div>
